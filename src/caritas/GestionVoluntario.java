...
public class GestionVoluntario {
   ...
   public ArrayList<Voluntario> getTodosVoluntarios(){
       
       ArrayList<Voluntario> resultadoVoluntario = new ArrayList();
       ResultSet resultadoLista=null;
     ...
     try {
       ...
       String sql = "SELECT *"
                        + " FROM voluntario order by Apellidos";
        ...
        try {
                ...
                while (resultadoLista.next()) 
                {
                        ...
                        String observaciones = resultadoLista.getString("Observaciones");
                        Blob cod_qr = resultadoLista.getBlob("cod_qr");
                        Voluntario voluntario = new Voluntario (cod_voluntario1,nombre,apellidos,dni,direccion,
                        telefono1,telefono2,fecha_empadronamiento,zona,horario,observaciones,cod_qr);
                        resultadoVoluntario.add(voluntario);
                }
        }catch (Exception e) {
            System.out.print("Error");
            System.out.print(sql);
